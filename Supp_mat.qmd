...
La instalación del paquete puede realizarse facilmente desde R clonando el repositorio disponible en GitHub empleando la función `install_github` de los paquetes **devtools** `r citep(citation("devtools"))` y **remotes** `r citep(citation("remotes"))`.
...
eidos_results[c("supplied_genus", "supplied_species", "name",
                "taxonid", "nametype", "acceptednameid")]
...
head(eidos_subsp1[c("supplied_genus", "supplied_species", "name",
               "taxonid", "nametype", "acceptednameid")],
     n = 3)
...
head(eidos_subsp2[c("supplied_genus", "supplied_species", "name",
               "taxonid", "nametype", "acceptednameid")],
     n = 3)
```
...
eidos_cons = eidosapi::eidos_conservation_by_id(
  taxon_id = eidos_results$taxonid
  )
